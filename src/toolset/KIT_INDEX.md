...
| Vision | 屏幕,截图,点击,窗口,IM,app,微信,程序,扫描,打标,元素,迅雷,弹窗,确认按钮,screenshot,vision,ocr | desktop_snap, desktop_grounding_scan, desktop_click, desktop_type, vnode_grounding_scan, vnode_grounding_click, vnode_grounding_type, vnode_camera_snap | 控制桌面 App、点击 UI、截图打标分析。本地直连优先用 desktop_* 工具 |
